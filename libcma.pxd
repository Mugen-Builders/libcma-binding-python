...
cdef extern from "stddef.h":
    ctypedef signed long ptrdiff_t
...
cdef extern from "/usr/include/libcma/ledger.h":
    ...
    ctypedef struct cma_ledger_account_balance_t:
        uint32_t type
    ...
    ctypedef struct cma_ledger_account_balance_info_t:
        ptrdiff_t offset
        size_t index
        cma_ledger_account_balance_t *balance

    int cma_ledger_init(cma_ledger_t *ledger)
    int cma_ledger_init_file(cma_ledger_t *ledger, char *memory_file_name,
        size_t offset, size_t mem_length, size_t n_accounts, size_t n_assets, size_t n_balances);

    int cma_ledger_init_single_file(cma_ledger_t *ledger, const char *memory_file_name, size_t offset,
    ...
    int cma_ledger_retrieve_account(cma_ledger_t *ledger, cma_ledger_account_id_t *account_id,
        cma_ledger_account_t *account, const void *addr_accid, size_t *n_balances,
        cma_ledger_account_type_t *account_type, cma_ledger_retrieve_operation_t operation)
    # Deposit
